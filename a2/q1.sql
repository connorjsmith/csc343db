...
CREATE VIEW BucketedStudentPercentages AS (
    SELECT assignment_id,
           ...
           (CASE WHEN (percentage >= 60 AND percentage <= 79) THEN 1 ELSE 0 END) as bool60_79,
           (CASE WHEN (percentage >= 50 AND percentage <= 59) THEN 1 ELSE 0 END) as bool50_59,
